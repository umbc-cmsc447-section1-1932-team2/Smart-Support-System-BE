...
export class TicketController {
  ...
  /**
   * GET /ticket/assigned
   * Agent and Admin see all tickets assigned to them.
   */
  @Roles(Role.AGENT, Role.ADMIN)
  @HttpCode(200)
  @Get('/assigned')
  ...
  /**
   * Agents and Admins see the global queue of unassigned OPEN tickets.
   */
  @Roles(Role.AGENT, Role.ADMIN)
  @HttpCode(200)
  @Get('/queue') 
  async getQueue() {
    return asyncWrapper(() => this.ticketService.getQueue());
  }
  ...
  /**
   * 
   * AGENTS and ADMINS can assign an agent to a ticket .
   */
  @Roles(Role.AGENT, Role.ADMIN) 
  @HttpCode(200)
  @Patch('/:id/assign')
